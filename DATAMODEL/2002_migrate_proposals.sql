...
BEGIN
    ...
    **/
    ...
    INSERT INTO toms."RestrictionPolygons"(
           "RestrictionID", geom, "RestrictionTypeID", "GeomShapeID", "Notes", "Photos_01", "Photos_02", "Photos_03", "RoadName", "USRN", "label_Rotation", "label_TextChanged", "OpenDate", "CloseDate", "LastUpdateDateTime", "LastUpdatePerson", "Orientation", "LabelText", "NoWaitingTimeID", "NoLoadingTimeID", "HoursOfControl", "AreaPermitCode", "CPZ", "ComplianceRoadMarkingsFaded", "ComplianceRestrictionSignIssue", "ComplianceNotes", "MHTC_CheckIssueTypeID", "MHTC_CheckNotes", "MatchDayTimePeriodID", "CreateDateTime", "CreatePerson", "AdditionalConditionID", label_pos, label_ldr, "MatchDayEventDayZone")
