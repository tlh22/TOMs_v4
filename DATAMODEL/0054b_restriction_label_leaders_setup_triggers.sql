...
CREATE TRIGGER z_insert_mngmt
    BEFORE INSERT OR UPDATE OF "HoursOfControl", "MaxStayID", "NoReturnID", "MatchDayTimePeriodID", "AdditionalConditionID", "PermitCode", "geom", "label_pos", "label_ldr"
    ON toms."Bays"
    FOR EACH ROW
...
CREATE TRIGGER z_insert_mngmt
    BEFORE INSERT OR UPDATE OF "HoursOfControl", "NoLoadingTimeID", "MatchDayTimePeriodID", "AdditionalConditionID", "geom", "label_pos", "label_ldr", "label_loading_pos", "label_loading_ldr"
    ON toms."Lines"
    FOR EACH ROW
    EXECUTE FUNCTION toms.labelling_for_restrictions();
