...
class CadNodeToolPlugin:
    ...
    def onCurrentLayerChanged(self):
        ...
        TOMsMessageLog.logMessage("In NodeTool:onCurrentLayerChanged", level=Qgis.MessageLevel.Info)
    ...
    def onEditingStartStop(self):
        ...
        TOMsMessageLog.logMessage("In NodeTool:onEditingStartStop", level=Qgis.MessageLevel.Info)
